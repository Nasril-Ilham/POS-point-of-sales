    ...
    $(document).ready(function() {
        $("#form-delete").validate({
            ...
            submitHandler: function(form) {
                $.ajax({
                    url: form.action,
                    type: 'POST', // Tetap POST karena Laravel akan membaca _method DELETE dari serialize()
                    data: $(form).serialize(),
                    ...
                    error: function(xhr) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Gagal menghapus data. Pastikan tidak ada data barang yang terkait dengan kategori ini.'
                        });
                    }
                });
                return false;
